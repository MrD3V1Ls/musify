    ...
    <body>
        <div class="pageContainer">
            <div class="leftPannel">
                <ul class="menuList">
                    <li class="menuListItem" @click="navigateToHome">
                        <p>
                            <span class="listIcon">
                    ...
                    <li class="menuListItem" @click="navigateToSearch">
                        <p>
                            <span class="listIcon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                    <path
                                        d="M11.3 10.9L14.4 14c.2.2.2.5 0 .7-.1.1-.3.1-.5.1-.2 0-.4-.1-.5-.2l-3.1-3.1c-1 1.1-2.4 1.7-3.9 1.7C3.7 12.5 0 8.8 0 4.8 0 1.8 2.8 0 6.2 0c3.5 0 6.2 2.1 6.2 4.8 0 1-.3 2.1-.8 3.1zM1.6 4.8c0 3.1 2.3 5.5 4.6 5.5 1.5 0 2.9-.6 3.9-1.6l3.1 3.1c.2.2.5.2.7 0 .1-.2.1-.4 0-.6l-3.1-3.1c1.1-.9 1.7-2.3 1.7-3.8 0-3.1-2.3-5.5-4.6-5.5C3.3 0 1.6 2.4 1.6 4.8z"
                                        stroke="#fff" />
                                </svg>
                            </span>
                            Search
                    ...
                    <li class="menuListItem" @click="sortLikedSongs">
                        <p>
                            <span class="listIcon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-heart" viewBox="0 0 16 16">
                                    <path
                                        d="M11.06 3.373a3.745 3.745 0 0 0-5.302 0L8 4.414l1.242-1.04a3.745 3.745 0 0 0-5.302 0C2.392 4.066 2 5.02 2 6.028c0 1.363.883 2.635 2.352 4.013C5.153 12.362 7.461 14 8 14c.538 0 2.847-1.638 3.648-3.96C13.117 8.663 14 7.39 14 6.027c0-.908-.392-1.962-1.06-2.654z" />
                                </svg>
                            </span>
                            Liked Songs
                        </p>
                    </li>
                    <li class="menuListItem" @click="getAllSongs">
                        <p>
                            <span class="listIcon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-music-note-list" viewBox="0 0 16 16">
                                    <path
                                        d="M2 7h5v6H2V7zm6-3h5v9H8V4zm6 2H8v5h6V6zm0-2a1 1 0 0 0-1 1v7a1 1 0 0 0 2 0V5a1 1 0 0 0-1-1z" />
                                    <path fill-rule="evenodd"
                                        d="M0 3.5A1.5 1.5 0 0 1 1.5 2h13A1.5 1.5 0 0 1 16 3.5v9a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 0 12.5v-9zm1.5-1A2.5 2.5 0 0 0 0 3.5v9A2.5 2.5 0 0 0 2.5 15h13A2.5 2.5 0 0 0 18 12.5v-9A2.5 2.5 0 0 0 15.5 1h-13z" />
                                </svg>
                            </span>
                            All Songs
                        </p>
                    </li>
                    <li class="menuListItem" @click="sortData">
                        <p>
                            <span class="listIcon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-sort" viewBox="0 0 16 16">
                                    <path d="M4 2h8v2H4V2zm0 5h5v2H4V7zm0 5h3v2H4v-2z" />
                                    <path fill-rule="evenodd"
                                        d="M9.5 1a.5.5 0 0 1 .5.5V14a.5.5 0 0 1-1 0V1.5a.5.5 0 0 1 .5-.5z" />
                                    <path fill-rule="evenodd"
                                        d="M7.646 10.854a.5.5 0 0 1-.708 0L3.146 7.354a.5.5 0 0 1 .708-.708L8 9.293l4.146-4.147a.5.5 0 0 1 .708.708L8.707 10.854a.5.5 0 0 1-.708 0z" />
                                </svg>
                    ...
                    <div class="pageSection">
                        <div href="" class="sectionBox2">
                            <div class="sectionImage"
                                :style="{ backgroundImage: `url(${tracks[currentTrackIndex].cover})` }">
                            </div>
                            <div class=" sectionContent">
                                <h4 class="sectionTitle">{{ tracks[currentTrackIndex].name }}</h4>
                    ...
                    <div class="player-controls">
                        <div class="player-controls__item" @click="playMusic(index, 'previous')">
                            <svg class="icon">
                                <use xlink:href="#icon-prev"></use>
                            </svg>
                        </div>
                        <div class="player-controls__item -xl js-play" @click="playMusic(this.currentTrackIndex, 'play')">
                            <svg class="icon">
                                <use xlink:href="#icon-pause" v-if="tracks[currentTrackIndex].playing"></use>
                                <use xlink:href="#icon-play" v-else></use>
                            </svg>
                        </div>
                        <div class="player-controls__item" @click="playMusic(index, 'next')">
                            <svg class="icon">
            ...
            <div class="pageContent">
                <h1 class="pageHeading">Good Morning</h1>
                <div class="playList">
                    <div class="listItems" v-for="(track, index) in tracks" :key="index">
                        <div class="listImg" :style="{ backgroundImage: `url(${track.cover})` }">
                        </div>
                        <div class="listTitle"> {{ track.name }}</div>
                        <div class="player-controls">
                            <div class="player-controls__item -xl js-play" @click="playMusic(index, 'play')">
                                <svg class="icon">
                                    <use xlink:href="#icon-pause" v-if="track.playing"></use>
                                    <use xlink:href="#icon-play" v-else></use>
                                </svg>
                            </div>
                            <div class="player-controls__item -favorite" :class="{ active: track.favorited }"
                ...
                <h2 class="sectionHeading">Your Top Mixes</h2>
                <div class="pageSection">
                    <div href="" class="sectionBox" v-for="(track, index) in tracks" :key="index">
                        <div class="sectionImage" :style="{ backgroundImage: `url(${track.cover})` }">
                        </div>
                        <div class=" sectionContent">
                            <h4 class="sectionTitle">{{ track.name }}</h4>
                            <p>{{ track.artist }}</p>
                        </div>
                        <div class="player-controls">
                            <div class="player-controls__item -xl js-play" @click="playMusic(index, 'play')">
...
export default {
    ...
    methods: {
        async sortData() {
            ...
            try {
                this.tracks = (await API.addData(tracks)).tracks;
            }
            catch (error) {
        ...
        sortLikedSongs() {
            ...
            this.tracks = this.tracks.filter((songsObject) => { if (songsObject.favorited) { return songsObject } });
        },
        getAllSongs() {
            this.tracks = tracks;
        },
        playMusic(trackIndex, isPlayButton) {
            switch (isPlayButton) {
                case 'play':
                    this.tracks.forEach((track) => {
                        if (track.source != this.tracks[trackIndex].source) {
                            track.playing = false;
                        }
                    });
                    this.tracks[trackIndex].playing = !this.tracks[trackIndex].playing;
                    this.currentTrack = this.tracks[trackIndex];
                    this.resetPlayer();
                    if (this.tracks[trackIndex].playing) {
                        this.audio.play();
                        this.isTimerPlaying = true;
                        this.currentTrackIndex = trackIndex;
                        //this.tracks[trackIndex].playing = true;
                    } else {
                        this.audio.pause();
                        this.isTimerPlaying = false;
                        //this.tracks[trackIndex].playing = false;
                    }
                    break;
                case 'next':
        ...
        favorite(trackIndex) {
            this.tracks[trackIndex].favorited = !this.tracks[
                trackIndex
            ].favorited;
        },
        async fetchSongs() {
...
@import '../pages/css/miniStyle.css';
</style>