    ...
    <div class="pageContainer">
        ...
        <div class="pageContent">
            <div class="search-page">
                ...
                <div class="playList">
                    <div class="listItems" v-for="(track, index) in searchResults" :key="index">
                        <div class="listImg" :style="{ backgroundImage: `url(${track.cover})` }">
                        </div>
                        <div class="listTitle"> {{ track.name }}</div>
                        <div class="player-controls">
                            <div class="player-controls__item -xl js-play" @click="playMusic(index)">
                                <svg class="icon">
...
export default {
    data() {
        return {
            ...
            transitionName: null,
            players: [
                { name: "Mr.D3V1L", score: 0 },
                { name: "DeNuke", score: 0 },
                { name: "Prince PR", score: 0 },
                { name: "Marsh", score: 0 },
                { name: "Poppingash", score: 0 },
                { name: "Mr.D3V1L", score: 0 },
                { name: "DeNuke", score: 0 },
                { name: "Prince PR", score: 0 },
                { name: "Marsh", score: 0 },
    ...
    methods: {
        ...
        async search() {
            ...
            this.loading = true;
            // Make API call to search for results based on searchQuery
            // Replace with actual API call
            this.searchResults.push(tracks.find(track => track.name === this.searchQuery));
            console.log(this.searchResults);

            /*this.searchResults = await fetch(`https://api.example.com/search?q=${this.searchQuery}`)
        ...
        playMusic(trackIndex) {
            this.searchResults.forEach((track) => {
                if (track.source != this.searchResults[trackIndex].source) {
                    track.playing = false;
                }
            });
            console.log(this.searchResults[trackIndex].playing)
            this.searchResults[trackIndex].playing = !this.searchResults[trackIndex].playing;
            this.currentTrack = this.searchResults[trackIndex];
            this.resetPlayer();
            if (this.searchResults[trackIndex].playing) {
                this.audio.play();
                this.isTimerPlaying = true;
                //this.searchResults[trackIndex].playing = true;
            } else {
                this.audio.pause();
                this.isTimerPlaying = false;
                //this.searchResults[trackIndex].playing = false;
            }
        },
